...
const Part3 = () => {
  return (
    <div className='flex flex-col md:flex-row justify-between mt-20 mb-20'>a
        <div className="left justify-center items-center p-10 ml-14 w-full  md:w-1/2">
    ...
    Get Started 
        ...
        <div className="right flex-col items-center gap-3  md:w-1/2 w-full flex justify-center  ">
